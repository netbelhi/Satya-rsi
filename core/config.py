...
# yfinance intraday limits: 1m ~7d max, 2m/5m/15m ~60d max, 60m ~730d, 1d ~max
# yfinance has NO native "3m" interval — 3m is built by resampling 1m candles.
# --------------------------------------------------------------------------
TIMEFRAMES = {
...
DEFAULT_TIMEFRAMES = ["1m", "2m", "3m", "5m", "15m", "1h", "1d"]
